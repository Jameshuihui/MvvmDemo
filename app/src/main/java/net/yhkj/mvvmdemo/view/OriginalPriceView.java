...
/**
 * 文件名：net.yhkj.mvvmdemo.view.OriginalPriceView
 * 创建者：MCeil
 * 邮箱：mceil_allin@163.com
 * 创建时间：2019/10/30
 * 描述：
 */
public class OriginalPriceView extends View {
    /**
     * 是否开启 千分符
     */
    ...
    private int mMoneyColor = Color.parseColor("#A7A7A7");

    private int mPrefixColor = Color.parseColor("#A7A7A7");
    /**
     * 前缀文本，例如¥
     */
    ...
    public OriginalPriceView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OriginalPriceView(Context context, AttributeSet attrs, int defStyle) {
