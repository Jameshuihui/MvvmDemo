...
public class NumberPickerView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    private void initNumberPickerView(final Context context, AttributeSet attrs) {
        ...
        // 背景
        int resourceId = typedArray.getResourceId(R.styleable.NumberButton_backgroud, R.color.white);
        int addResourceId = typedArray.getResourceId(R.styleable.NumberButton_addBackground, R.drawable.divider_horizontal);
        int subResourceId = typedArray.getResourceId(R.styleable.NumberButton_subBackground, R.drawable.divider_horizontal);
        // 水平分割线
