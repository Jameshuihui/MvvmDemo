...
import net.yhkj.mvvmdemo.minterface.CityInterface;
import net.yhkj.mvvmdemo.minterface.OnItemClickListener;
...
public class AddressSelector extends LinearLayout implements View.OnClickListener {
    private int TextSelectedColor = Color.parseColor("#FF8000");//设置tab选中 请选择   字体颜色
    private int TextEmptyColor = Color.parseColor("#FF8000");
    //顶部的tab集合
    ...
    //列表文字选中的颜色
    private int listTextSelectedColor = Color.parseColor("#FF8000");
    //列表icon资源
    ...
    public class Tab extends TextView {
        private int index = 0;
        private int TextSelectedColor = Color.parseColor("#FF8000"); //设置tab文字默认字体
    ...
    private class Line extends LinearLayout {
        ...
        private int SelectedColor = Color.parseColor("#FF8000");
