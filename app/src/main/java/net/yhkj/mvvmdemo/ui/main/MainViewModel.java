...
public class MainViewModel extends BaseViewModel<LoginRepository> {
    ...
    public void initData() {
        ...
        observableList.add(new MainItemViewModel(this, new MainBean("横向图片", 10)));
        observableList.add(new MainItemViewModel(this, new MainBean("步骤指示器", 11)));
        observableList.add(new MainItemViewModel(this, new MainBean("地址选择", 12)));
        ...
        observableList.add(new MainItemViewModel(this, new MainBean("更新提示", 18)));
        observableList.add(new MainItemViewModel(this, new MainBean("购物车测试", 19)));
        observableList.add(new MainItemViewModel(this, new MainBean("白酒", 20)));
