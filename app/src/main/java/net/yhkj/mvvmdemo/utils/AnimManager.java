...
public class AnimManager {
    ...
    private void createImageAndAnim(int[] startLocation, int[] endLocation) {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(dip2px(getActivity(), animWidth),
                dip2px(getActivity(), animHeight));
        animImageView.setLayoutParams(layoutParams);
        RequestOptions options = new RequestOptions();
        options.placeholder( R.drawable.ic_point);
